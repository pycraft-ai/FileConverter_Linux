...
@app.before_request
def before_request():
    """请求前处理：检查IP黑名单并记录开始时间"""
    # 获取真实IP地址（兼容 Cloudflare 内网穿透）
